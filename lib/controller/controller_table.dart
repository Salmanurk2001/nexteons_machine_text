...
import 'package:nexteons_machine_text/model/model_table.dart';

class Controller_Table extends GetxController {
  ...
  Future<void> fetchData() async {
    try {
      final dio = Dio(BaseOptions(baseUrl: 'https://ajcjewel.com:4000/api/global-gallery/list'));
